...
local BossName = M:AddDropdown("Select Boss", bossCheck, function(value)
    _G.SelectBoss = value
end)

M:AddButton("Refresh Boss", function()
BossName:Clear()
wait(0.1)
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    M:AddToggle("Auto Farm Boss", _G.AutoFarmBoss, function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    M:AddToggle("Auto Katakuri V2", _G.Autodoughking, function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    M:AddToggle("Auto Katakuri V2 [Hop]", _G.AutodoughkingHop, function(value)
...
S:AddDropdown("Fast Attack Delay", AttackList, function(SimpRose)
...
S:AddToggle("Fast Attack", true, function(value)
        _G.FastAttack = value
    end)      
